...
var proto = SchemaType.prototype = {
  ...
  test: function test() {
    ...
    if (opts.message === undefined) {
      if (_locale.default[this._type] && _locale.default[this._type][opts.name]) {
        opts.message = _locale.default[this._type][opts.name];
      } else if (_locale.mixed[opts.name]) {
        opts.message = _locale.mixed[opts.name];
      } else {
